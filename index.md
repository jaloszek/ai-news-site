...
<link rel="canonical" href="2026-05.html" />
...
<section class="cal-month">
  ...
  <div class="cal-grid">
    ...
    <a class="cal-cell cal-filled" href="content/2026-05-25.html"><div class="cal-num">25</div><ul class="cal-highlights"><li>🛠 CC /usage — detailed resource tracking</li><li>📧 AI assistants in the legal sector</li><li>📧 Composer 2.5</li><li>💬 We're one step closer to technological</li><li>🎥 Polynomial Regression in Python</li></ul></a>
    <a class="cal-cell cal-filled" href="content/2026-05-26.html"><div class="cal-num">26</div><ul class="cal-highlights"><li>🛠 v2.1.153</li><li>🟢 Cisco and OpenAI redefine enterprise engineering</li><li>🟡 ITBench-AA: Frontier Models Score Below 50%</li><li>💬 1000 tps generation on Qwen3.6 27B</li><li>🎥 Qwen 3.7 Max: The Model Beating</li></ul></a>
    <a class="cal-cell cal-filled" href="content/2026-05-27.html"><div class="cal-num">27</div><ul class="cal-highlights"><li>🟡 ITBench-AA: Frontier Models Score Below 50%</li><li>📧 Datacurve releases DeepSWE</li><li>📝 Building OpenCode with Dax Raad</li><li>🎥 Gemini 3.5 Pro X-High</li></ul></a>
    <a class="cal-cell cal-filled" href="content/2026-05-28.html"><div class="cal-num">28</div><ul class="cal-highlights"><li>🛠 CC /loop — autonomous agent cycling</li><li>🟢 OpenAI announces GPT-5 reasoning improvements</li><li>🔵 Google Gemini 2.5 Pro release</li><li>📝 The Pulse: a trend of trying</li><li>🎥 Claude Mythos 1 Preview Leaked...</li></ul></a>
    <a class="cal-cell cal-filled" href="content/2026-05-29.html"><div class="cal-num">29</div><ul class="cal-highlights"><li>🛠 CC auto plugin loading and /plugin</li><li>🔥 Anthropic ships Opus 4.8 with Dynamic</li><li>💰 Anthropic raises $65B at $965B valuation</li><li>💬 GPT-5.6 spotted in Codex</li><li>🎥 Opus 4.8 (Fully Tested)</li></ul></a>
    <a class="cal-cell cal-filled" href="content/2026-05-30.html"><div class="cal-num">30</div><ul class="cal-highlights"><li>🛠 v2.1.157 — auto plugin loading</li><li>💰 Anthropic raises $65B at $965B valuation</li><li>🟢 Boston Children's Hospital diagnoses 40+ rare</li><li>💬 Here's &gt;100 evals for Opus 4.8</li><li>🎥 Claude Opus 4.8 + NEW Ultracode</li></ul></a>
    <a class="cal-cell cal-filled" href="content/2026-05-31.html"><div class="cal-num">31</div><ul class="cal-highlights"><li>🛠 Auto mode on Bedrock</li><li>📧 Meta researcher's OpenClaw agent autonomously d…</li><li>📧 Indirect prompt injection exfiltrates data</li><li>💬 31 tk/s in 3050 6gb vram</li><li>🎥 I Tried 100+ Claude Code Skills.</li></ul></a>
  </div>
</section>
