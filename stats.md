...
_Generated 2026-08-16 01:17 UTC. Snapshot of the daily ingestion + enrichment + publication pipeline._

## At a glance

- **Discovery items (in retention window):** 5926
- **Enriched:** 428 (7%)
- **Taste-rated:** 428 (7%)
- **Researched:** 314 (5%)
- **Status (candidate / rejected / published / duplicate):** 2698 / 3228 / 0 / 0
- **Published bullets (all-time):** 2166 (last 7d: 171)
...
|---|---|---:|
| arXiv cs.AI | `rss` | 3687 |
| arXiv cs.CL | `rss` | 2405 |
| TLDR | `email` | 2331 |
